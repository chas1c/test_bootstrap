...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.КоличествоПоказываемыхСобытий.ФорматРедактирования = "ЧГ=0; ЧФ='Ч " + СтрокаСЧислом(НСтр("ru = ';событие;;события;событий;события'", "ru"), КоличествоПоказываемыхСобытий, ВидЧисловогоЗначения.Количественное) + "'";
...
Процедура ПрочитатьЖурнал(Знач ОтборЖурналаНаКлиенте)
	...
	ТаблицаЗначенийСобытия.Колонки.Добавить("Картинка", Новый ОписаниеТипов("Картинка"));
	Для Каждого СтрокаТаблицыЗначенийСобытия Из ТаблицаЗначенийСобытия Цикл
		СтрокаТаблицыЗначенийСобытия.Картинка = Новый Картинка();
		Если СтрокаТаблицыЗначенийСобытия.Уровень = УровеньЖурналаРегистрации.Информация Тогда
			СтрокаТаблицыЗначенийСобытия.Картинка = БиблиотекаКартинок.ЗнакИнформация;
		ИначеЕсли СтрокаТаблицыЗначенийСобытия.Уровень = УровеньЖурналаРегистрации.Предупреждение Тогда
			СтрокаТаблицыЗначенийСобытия.Картинка = БиблиотекаКартинок.ВосклицательныйЗнак;
		ИначеЕсли СтрокаТаблицыЗначенийСобытия.Уровень = УровеньЖурналаРегистрации.Ошибка Тогда
			СтрокаТаблицыЗначенийСобытия.Картинка = БиблиотекаКартинок.ЗнакКрест;
		КонецЕсли;
