...
#Если НЕ МобильныйКлиент Тогда
	...
	Если Параметры.ТекущийТовар <> Неопределено И Параметры.ТекущийТовар < Объект.Товары.Количество() Тогда
		Элементы.Товары.ТекущаяСтрока = Объект.Товары[Параметры.ТекущийТовар].ПолучитьИдентификатор();
	КонецЕсли;
#КонецЕсли
	
    Элементы.СостояниеЗаказа.СписокВыбора.Добавить(Перечисления.СостоянияЗаказов.Открыт,,,БиблиотекаКартинок.КругЖелтый);
	Элементы.СостояниеЗаказа.СписокВыбора.Добавить(Перечисления.СостоянияЗаказов.ВРаботе,,,БиблиотекаКартинок.КругОранжевый);
	Элементы.СостояниеЗаказа.СписокВыбора.Добавить(Перечисления.СостоянияЗаказов.Выполнен,,,БиблиотекаКартинок.КругЗеленый);
	Элементы.СостояниеЗаказа.СписокВыбора.Добавить(Перечисления.СостоянияЗаказов.Закрыт,,,БиблиотекаКартинок.КругСиний);
